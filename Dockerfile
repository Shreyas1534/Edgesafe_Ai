...
# 8. Start Gunicorn and bind it to Railway's dynamic port
CMD sh -c "gunicorn -k geventwebsocket.gunicorn.workers.GeventWebSocketWorker -w 1 -b 0.0.0.0:${PORT:-8080} app:app"